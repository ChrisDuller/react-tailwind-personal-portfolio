        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative animate-fade-in animation-delay-300 lg:order-2">
                        <div className="relative max-w-md mx-auto">
                            ...
                            <div className="relative glass rounded-3xl p-2 glow-border">
                                <img src="/profile-photo.jpg" alt="Chris D" className="w-full aspect-[4/5] object-cover rounded-2xl" />

                                { /* Floating Badge */ }
                                <div className="absolute -buttom-4 -right-4 glass rounded-xl px-4 py-3 animate-float">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                                Testing <span className="text-primary glow-text">digital</span>
                                <br />
                                experiences with
                                <br />
                            ...
                            <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                                Hi, I'm Chris D - a digital developer in React, Next.js, and TypeScript. I build scalable, performant we applications that users love.
                            </p>
                        </div>
                        ...
                        <div className="flex animate-marquee">
                            {
                                [...skills, ...skills].map((skill, idx)=>(
                                    <div key={idx} className="flex-shrink-0 px-8 py-4">
                                        <span className="text-xl font-semibold text-muted-foreground/50 hover:text-muted-foreround transition-colors">{skill}</span>
                                    </div>
                                ))
                            }
                        </div>
